...
$(document).ready(function(){
  ...
  $('#iseappname_select').change(function(){
	  ...
	  tdValueArray = getCurrentValue('type');//Get all the column td values
      removeOptions('option.type_option');
	  //tdValueArray = getCurrentValue('environment');//Get all the column td values
      //removeOptions('option.type_option');
 ...
 $('#instancenode_select').change(function(){
	...
	$('#type_select').change(function(){
	  var selected = $("#type_select option:selected").val();
	  //console.log(selected);
	  hideRows('type',selected); //hide all the rows that are not selected
