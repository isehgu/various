...
# OAT #
$CSVFile_OAT_win    = "//ix-ftp01/EFTRoot/data/ApplicationVersions/windowsAppVersions_OAT.csv"; 
$CSVFile_OAT_unx    = "//ix-ftp01/EFTRoot/data/ApplicationVersions/coreAppVersions_OAT.csv"; 
...
} elseif (file_exists($CSVFile_OAT_win) or file_exists($CSVFile_OAT_unx)) {
	$environment = "OAT";
	$rows_win    = explode("\r\n", file_get_contents($CSVFile_OAT_win));
	$rows_unx    = explode("\r\n", file_get_contents($CSVFile_OAT_unx));
