...
<html>
	...
	<div class='col-md-6'>
        ...
        <div class="form-group">
          <input type="text" class="form-control" name='textstring' placeholder="Search" value="<?php echo $_GET['textstring']; ?>">
        </div>
				...
				<!--div class='col-md-6'>
					<form id='searchtext' method='get' action='#'>
						<div id='searchdiv' class='input-group col-md-4'>
							<input type='text' class='form-control' name='textstring' 
								placeholder='Free text search on all columns' 
