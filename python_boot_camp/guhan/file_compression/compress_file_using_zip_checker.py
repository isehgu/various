...
import subprocess
#try:
import compress_file_using_zip_template as file_compr
#except:
#    import compress_file_using_zip as file_compr
#    print "Imported %s" % compress_file_using_zip
import os
sys.path.append("/home/scroller/python_bootcamp/admin/file_compression")
...
with Capturing() as output:
    captured_return_val = file_compr.compress_file_using_zip('.', FILE_TO_ZIP)
if output[-1] == "":
    output.pop()
...
print "2.\nAnalyzing your output, line by line. Ignoring the first line."
