<?php
  ...
  function f_displayTask($id)
  {
	...
	";
	if($complete) echo "<label>Rank:</label><input class='input-mir' type='text' name='rank' placeholder='Enter Rank Here' value='$rank' disabled>";
	else echo "<label>Rank:</label><input class='input-mir' type='text' name='rank' placeholder='Enter Rank Here' value='$rank'>";
	echo "
