...
<html>
	...
	<body>
		...
		<div class='container-fluid'>
			...
			<div class='row-fluid'>
				<div class='span12 sectionheading lead'>
					Completed Tasks
				</div>
			</div>
			<?php f_displayComplete(); ?>
		</div>
      ...
      <a href='' id='completebtn' class="btn btn-primary pull-right" title='Complete'><i id='changeablebtnicon' class='icon-ok icon-white'></i></a>
		  </div>
